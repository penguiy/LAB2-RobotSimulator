...
RangeSensor::RangeSensor(std::string aId, double angleOffset, double maxRange, double aInitVal)
    : Sensor(std::move(aId), aInitVal), mAngleOffset(angleOffset), mMaxRange(maxRange)
{
}
